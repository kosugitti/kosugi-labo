...
JPAに沿った引用文献スタイルは\url{https://github.com/kosugitti/biblatex-jpa2}から入手する。
リポジトリの\texttt{biblatex/}内にある\texttt{jpa2.bbx}，\texttt{jpa2.cbx}，\texttt{jpa2.dbx}，\texttt{english-jpa2.lbx}，\texttt{japanese-jpa2.lbx}の5ファイルを同じディレクトリに置く。
プリアンブルで以下のように指定：
\begin{verbatim}
\usepackage[backend=biber,style=jpa2]{biblatex}
